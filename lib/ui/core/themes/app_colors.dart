...
///
/// Widgets never reference a raw [Color] literal; they read a role from
/// `context.colors`, so a second palette (dark mode, high contrast) only has to
/// supply a new [AppColors] instance.
@immutable
class AppColors extends ThemeExtension<AppColors> {
  ...
  /// Palette matching the light Figma design.
  ...
  /// Dark counterpart, derived from the same iOS system palette.
  ...
  /// Background of cards, lists and sheets.
  final Color surface;

  /// Background of a surface that sits above another surface.
  final Color surfaceElevated;

  /// Background of inline chips and inputs.
  final Color fill;

  /// Primary text and icons.
  final Color label;

  /// Supporting text, timestamps and inactive icons.
  final Color secondaryLabel;

  /// Interactive accent for links, active tabs and primary actions.
  final Color accent;

  /// Content drawn on top of [accent].
  final Color onAccent;

  /// Missed calls, destructive actions.
  ...
  /// Background of an avatar with no photo.
  final Color avatarFill;

  /// Initials drawn on top of [avatarFill].
  final Color onAvatar;

  /// Blurred bar backgrounds.
  ...
  /// widgets stay in step with the design system.
